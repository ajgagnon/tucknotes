...
import { LinkPopover, LinkContent, LinkButton } from "@/editor/ui/link-popover";
...
export function SimpleEditor({
  ...
  const markdownEmitDebounceRef = useRef<ReturnType<typeof setTimeout> | null>(
    null,
  );
    ...
    const meetingExtensions = meetingNoteMode
      ? [
          ...
          MeetingNoteElapsed.configure({
            getElapsedSecs: () =>
              meetingNoteRef.current?.stampElapsedSecs ?? null,
          }),
        ]
      : [];
