// @ts-nocheck — vendored from ai-elements; type signatures diverge from this project's
// @base-ui/react-based shadcn primitives (event types, hover-card props). Runtime is fine.
"use client";
